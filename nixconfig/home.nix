...

{
  ...
  # manage.
  home.username = "thomad";
  home.homeDirectory = "/home/thomad";
  ...
  home.file = {
    ...
    ".config/kanata".source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/nixos-config/dotfiles/kanata";
  };
  ...
  # or
  #
  #  /etc/profiles/per-user/thomad/etc/profile.d/hm-session-vars.sh
  #
